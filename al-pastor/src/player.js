...
export default class Player extends Entity {
    ...
    animate(ctx) {
        ...
        switch (this.status) {
            case "idle":
                ctx.drawImage(this.img, 0, 0, 20, 20, this.pos.x, this.pos.y, 60, 60);
                break;
            case "lost":
                ctx.drawImage(this.img, 20*8, 0, 20, 20, this.pos.x, this.pos.y, 60, 60);
                break;
            case "jumping":
                ctx.drawImage(this.img, 20*7, 0, 20, 20, this.pos.x, this.pos.y, 60, 60);
                break;
            case "running":
                ...
                ctx.drawImage(this.img, this.frame*20, 0, 20, 20, this.pos.x, this.pos.y, 60, 60);
                break;
        }
    }
